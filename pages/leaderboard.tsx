...
export default function Leaderboard() {
    ...
    const { HEAD, NECK, NOOSE, EAR, EYE, NECKLACE, HAIR, GLASS, CLOTHE, TEETH, TONGUE, EARINGS, RANK } = router.query

    if (!HEAD || !NECK || !NOOSE || !EAR || !EYE || !NECKLACE || !HAIR || !GLASS || !CLOTHE || !TEETH || !TONGUE || !EARINGS || !RANK) {
        return (
            <>
                <p>
    ...
    return (
        <Canvas gl={{ preserveDrawingBuffer: true, antialias: true, alpha: true }} camera={{ fov: 50 }} shadows>
            <Suspense fallback={null}>
                <Stage contactShadow shadows adjustCamera={1} intensity={0.6} environment="sunset" preset="portrait">
                    <Caustics backside lightSource={[2.5, 5, -2.5]}>
                        ...
                        {renderComponent(EARINGS, componentProps)}
